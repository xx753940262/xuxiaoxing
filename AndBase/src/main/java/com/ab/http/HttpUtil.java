...
public class HttpUtil {
    ...
    public static void httpClientPostSend(final Context response, AbRequestParams params, final String url) {
        httpClientSend((OnMessageResponse) response, params, url);
    }
    ...
    private static void httpClientSend(final OnMessageResponse response, AbRequestParams params, final String url) {
        AbLogUtil.e("SERVICE_URL==", SERVICE_URL + url);
