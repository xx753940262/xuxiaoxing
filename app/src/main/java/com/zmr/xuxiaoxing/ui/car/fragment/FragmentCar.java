package com.zmr.xuxiaoxing.ui.car.fragment;
...
import com.zmr.xuxiaoxing.ui.car.activity.QueRenDingDanActivity;
import com.zmr.xuxiaoxing.ui.car.adapter.Adapter_Shopcart;
import com.zmr.xuxiaoxing.ui.car.model.CarDel;
import com.zmr.xuxiaoxing.ui.car.model.CarList;
 ...
 */
public class FragmentCar extends BaseFragment implements Adapter_Shopcart.CheckInterface,
        Adapter_Shopcart.ModifyCountInterface, Adapter_Shopcart.GroupEdtorListener, OnMessageResponse ,View.OnClickListener{

    public static FragmentCar instance;
    ImageView back;
    TextView title;
    TextView subtitle;
    LinearLayout topBar;
...
//        initDatas();
    ...
    public static FragmentCar getSingleton() {
        if (instance == null) {
            synchronized (BaseApplication.class) {
                if (instance == null) {
                    instance = new FragmentCar();
                }
            }
        }
        return instance;
    ...
    public void initView(View view, LayoutInflater inflater) {
        ...
        mSwipyRefreshLayout.setOnRefreshListener(new SwipyRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(int index) {
                ...
                BaseApi.carList(FragmentCar.this, sHelper.getString(BaseConstant.TOKEN), sHelper.getString(BaseConstant.UID));
            }
...
//            ProgressDialogUtils.showProgressDialog(getActivity(), "数据加载中...");
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.carDel(FragmentCar.this, sHelper.getString(BaseConstant.TOKEN), childs.get(j).getRecId() + "", sHelper.getString(BaseConstant.UID));
    ...
    protected void collect() {
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.productCollectCar(FragmentCar.this, childs.get(j).getGoodsId(), sHelper.getString(BaseConstant.UID), sHelper.getString(BaseConstant.TOKEN));
                }
            }
