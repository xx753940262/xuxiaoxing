package com.zmr.xuxiaoxing.ui.shopcar.activity;
 ...
 */
public class CarActivity extends BaseActivity implements Adapter_Shopcart.CheckInterface,
        Adapter_Shopcart.ModifyCountInterface, Adapter_Shopcart.GroupEdtorListener, OnMessageResponse, View.OnClickListener {

    public static CarActivity instance;
    ImageView back;
    TextView title;
    TextView subtitle;
    LinearLayout topBar;
    ...
    public void initView(View view) {
        ...
        mSwipyRefreshLayout.setOnRefreshListener(new SwipyRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(int index) {
                ...
                KLog.e("onRefresh======>>>获取web段购物车数据===>>getWebCartList");
                BaseApi.carList(CarActivity.this, sHelper.getString(BaseConstant.TOKEN), sHelper.getString(BaseConstant.UID));
            }
...
//            ProgressDialogUtils.showProgressDialog(getActivity(), "数据加载中...");
    ...
    public void cartList() {
        ...
        if (groups != null && children != null && mAdapterShopcart != null) {
            ...
            KLog.e("cartList======>>>获取web段购物车数据===>>getWebCartList");
            BaseApi.carList(CarActivity.this, sHelper.getString(BaseConstant.TOKEN), sHelper.getString(BaseConstant.UID));
        }
    }
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.carDel(CarActivity.this, sHelper.getString(BaseConstant.TOKEN), childs.get(j).getRecId() + "", sHelper.getString(BaseConstant.UID));
    ...
    protected void collect() {
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.productCollectCar(CarActivity.this, childs.get(j).getGoodsId(), sHelper.getString(BaseConstant.UID), sHelper.getString(BaseConstant.TOKEN));
                }
            }
...
//                                checkAll();
                            ...
                            intent.setClass(CarActivity.this, QueRenDingDanActivity.class);
