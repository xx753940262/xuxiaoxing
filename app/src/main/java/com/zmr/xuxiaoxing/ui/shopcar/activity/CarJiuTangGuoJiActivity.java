...
import com.zmr.xuxiaoxing.ui.shopcar.model.CarDelDzfk;
import com.zmr.xuxiaoxing.ui.shopcar.model.GoodsInfo2;
import com.zmr.xuxiaoxing.ui.shopcar.model.M_QueRenDingDanGoods;
import com.zmr.xuxiaoxing.ui.shopcar.model.OrderConfirmDzfk;
import com.zmr.xuxiaoxing.ui.shopcar.model.ShopCarJiuTangGuoJi;
 ...
 */
public class CarJiuTangGuoJiActivity extends BaseActivity implements Adapter_Shopcart.CheckInterface,
        Adapter_Shopcart.ModifyCountInterface, Adapter_Shopcart.GroupEdtorListener, OnMessageResponse, View.OnClickListener {

    public static CarJiuTangGuoJiActivity instance;
    ImageView back;
    TextView title;
    TextView subtitle;
    LinearLayout topBar;
    ...
    public static CarJiuTangGuoJiActivity getSingleton() {
        if (instance == null) {
            synchronized (BaseApplication.class) {
                if (instance == null) {
                    instance = new CarJiuTangGuoJiActivity();
                }
            }
        }
        return instance;
    ...
    public void initView(View view) {
        ...
        mSwipyRefreshLayout.setOnRefreshListener(new SwipyRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(int index) {
                ...
                BaseApi.carList(CarJiuTangGuoJiActivity.this, sHelper.getString(BaseConstant.TOKEN), sHelper.getString(BaseConstant.UID));
            }
...
//            ProgressDialogUtils.showProgressDialog(getActivity(), "数据加载中...");
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.carDel(CarJiuTangGuoJiActivity.this, sHelper.getString(BaseConstant.TOKEN), childs.get(j).getRecId() + "", sHelper.getString(BaseConstant.UID));
    ...
    protected void collect() {
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.productCollectCar(CarJiuTangGuoJiActivity.this, childs.get(j).getGoodsId(), sHelper.getString(BaseConstant.UID), sHelper.getString(BaseConstant.TOKEN));
                }
            }
...
//                            intent.setClass(CarJiuTangGuoJiActivity.this, QueRenDingDanActivity.class);
//                            intent.putExtra("M_QueRenDingDanGoods", getSelectedGoods());
//                            intent.putExtra("type", "gouwuche");
//                            startActivityForResult(intent, 200);
                            getSelectedGoods();
                            BaseApi.orderConfirmOrder(CarJiuTangGuoJiActivity.this, sHelper.getString(BaseConstant.TOKEN), sHelper.getString(BaseConstant.UID), AbStrUtil.cutLastString(mRec_id), "", "", "", "", "");
