 ...
 */
package com.xiaoxing.common.image.abimage;
...
import com.xiaoxing.common.cache.AbCacheHeaderParser;
import com.xiaoxing.common.cache.AbCacheResponse;
import com.xiaoxing.common.cache.AbCacheUtil;
import com.xiaoxing.common.cache.AbDiskBaseCache;
import com.xiaoxing.common.cache.image.AbBitmapResponse;
import com.xiaoxing.common.cache.image.AbImageBaseCache;
import com.xiaoxing.common.task.AbTaskObjectListener;
import com.xiaoxing.common.util.AbAppUtil;
import com.xiaoxing.common.global.AbAppConfig;
import com.xiaoxing.common.task.AbTaskItem;
import com.xiaoxing.common.task.thread.AbTaskQueue;
import com.xiaoxing.common.util.AbFileUtil;
import com.xiaoxing.common.util.AbImageUtil;
import com.xiaoxing.common.util.AbLogUtil;
import com.xiaoxing.common.util.AbStrUtil;
import com.xiaoxing.common.cache.AbDiskCache;
...
//                imageView.setImageBitmap(null);
    ...
    public AbBitmapResponse getBitmapResponse(String url, int desiredWidth, int desiredHeight) {
        ...
        try {
            ...
            Bitmap bitmap = null;
            //看磁盘
            AbDiskCache.Entry entry = diskCache.get(cacheKey);
