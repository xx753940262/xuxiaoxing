 ...
 */
package com.xiaoxing.common.view.chart;
...
public abstract class XYChart extends AbstractChart {
  ...
  protected void drawSeries(XYSeries series, Canvas canvas, Paint paint, List<Float> pointsList,List<Integer> colorsList,
      SimpleSeriesRenderer seriesRenderer, float yAxisValue, int seriesIndex, XYMultipleSeriesRenderer.Orientation or,
      int startIndex) {
   ...
   * @see AbstractChart#getSeriesAndPointForScreenCoordinate(Point)
   * @author: amsoft.cn
