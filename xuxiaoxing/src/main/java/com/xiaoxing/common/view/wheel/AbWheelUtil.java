 ...
 */
package com.xiaoxing.common.view.wheel;
...
import com.xiaoxing.common.util.AbDateUtil;
import com.xiaoxing.common.util.AbDialogUtil;
import com.xiaoxing.common.util.AbStrUtil;
import com.xiaoxing.common.view.wheel.AbWheelView.AbOnWheelChangedListener;
...
public class AbWheelUtil {
     ...
     * @param initStart     轮子是否初始化默认时间为当前时间
     */
    public static void initWheelDatePickerByYearDay(final Activity activity, final TextView mText, final AbWheelView mWheelViewY, final AbWheelView mWheelViewM, final AbWheelView mWheelViewD,
                                                    Button okBtn, Button cancelBtn,
                                                    int defaultYear, int defaultMonth, int defaultDay, final int startYear, int endYearOffset, boolean initStart) {
...
//        mText.setText(AbStrUtil.dateTimeFormatByYearDay(defaultYear + "-" + defaultMonth));
        final List<String> list_big = Arrays.asList(months_big);
        final List<String> list_little = Arrays.asList(months_little);

        //设置"年"的显示数据
        mWheelViewY.setAdapter(new AbNumericWheelAdapter(1970, endYear));
        mWheelViewY.setCyclic(true);// 可循环滚动
        mWheelViewY.setLabel("年");  // 添加文字
        mWheelViewY.setCurrentItem(defaultDay - startYear - 116);// 初始化时显示的数据
        mWheelViewY.setValueTextSize(35);
        mWheelViewY.setLabelTextSize(35);
        mWheelViewY.setLabelTextColor(0x80000000);
        //mWheelViewY.setCenterSelectDrawable(this.getResources().getDrawable(R.drawable.wheel_select));
        ...
        okBtn.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                mText.setText(AbStrUtil.dateTimeFormatByYearDay(year + "-" + month));
            }
