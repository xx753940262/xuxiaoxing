 ...
 */
public class Activity_Car extends BaseActivity implements Adapter_Shopcart.CheckInterface,
        Adapter_Shopcart.ModifyCountInterface, Adapter_Shopcart.GroupEdtorListener, OnMessageResponse, View.OnClickListener {

    public static Activity_Car instance;
    ImageView back;
    TextView title;
    TextView subtitle;
    LinearLayout topBar;
    ...
    public void initView(View view) {
        ...
        mSwipyRefreshLayout.setOnRefreshListener(new SwipyRefreshLayout.OnRefreshListener() {
            ...
            public void onRefresh(int index) {
                ...
                BaseApi.carList(Activity_Car.this, sHelper.getString(BaseConstant.TOKEN), sHelper.getString(BaseConstant.UID));
            }
...
//            ProgressDialogUtils.showProgressDialog(getActivity(), "数据加载中...");
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.carDel(Activity_Car.this, sHelper.getString(BaseConstant.TOKEN), childs.get(j).getRecId() + "", sHelper.getString(BaseConstant.UID));
    ...
    protected void collect() {
        ...
        for (int i = 0; i < groups.size(); i++) {
            ...
            for (int j = 0; j < childs.size(); j++) {
                if (childs.get(j).isChoosed()) {
                    BaseApi.productCollectCar(Activity_Car.this, childs.get(j).getGoodsId(), sHelper.getString(BaseConstant.UID), sHelper.getString(BaseConstant.TOKEN));
                }
            }
...
//                                checkAll();
                            ...
                            intent.setClass(Activity_Car.this, QueRenDingDanActivity.class);
